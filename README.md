...
4. 复制lua下面的mouse.lua内内容到 ~/.hammerspoon/init.lua
...
- 按住 ⌥ Option 效果为🖱️**鼠标移动**， 额外按下⇧Shift将**移速翻倍** ⏫。 (`U`, `I`, `O`, `P` 映射为鼠标左击，中击、切换屏幕焦点，右击)。
...
| I        | Home     | 选至行首 | 尾至行首     | 上个窗口     | 隐藏窗口     | 🖱️M             | 🖱️M             | ⬆️    | ⬆️⏫   |
| O        | End      | 选至行尾 | 首至行尾     | 切换窗口     | 隐藏所有     | 多屏幕切换焦点 | 多屏幕切换焦点 | ⬇️    | ⬇️⏫   |
| P        | PgDn     | 选至下页 | 选至下页     | 放大         | 启动菜单     | 🖱️R             | 🖱️R             | ⬅️    | ⬅️⏫   |
...
| 键\修饰 | ✱                                        | ⌘              | ⌥                  | ……   |
| ------- | ---------------------------------------- | -------------- | ------------------ | ---- |
| E       | alfred                                   | edge           | Termius             |      |
| R       | Logseq                                   | tapd           | Visual Studio Code |      |
| T       | mstodo                                  | Typora         | Terminal           |      |
| Y       | Siri                                     | outlook        |                    |      |
| F       | qspace                                   | Easy find | Dictionary         |      |
| G       | wechat                                   | 企业微信         |       Calender(外部日历软件支持，这里不做设定)      |      |
